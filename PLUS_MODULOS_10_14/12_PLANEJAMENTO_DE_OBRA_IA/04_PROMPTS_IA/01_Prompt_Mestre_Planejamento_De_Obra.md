# Prompt Mestre Planejamento de Obra

## Finalidade
Este prompt ajuda a transformar informações dispersas sobre EAP, sequência executiva, cronograma conceitual, plano de compras e acompanhamento preliminar em uma saída técnica organizada, didática e segura. Ele foi criado para uso educacional, preliminar e referencial, com foco em clareza, rastreabilidade e validação humana.

## Quando usar
- quando a obra precisar de EAP, sequência de atividades, plano de compras ou relatório de avanço em nível conceitual; quando não houver cronograma executivo validado.
...
## Quando não usar
- não substitui cronograma executivo; não cria prazo contratual; não substitui gestão profissional de obra; não valida produtividade, equipes, contratos ou restrições reais; sempre encaminhar itens críticos para validação profissional.
...
- **Identificação da obra:** [preencher]
- **Tipo de obra e padrão construtivo:** [preencher]
- **Etapas conhecidas:** [preencher]
- **Escopo e restrições:** [preencher]
- **Equipe disponível, se informada:** [preencher]
- **Materiais e fornecedores conhecidos:** [preencher]
- **Datas ou marcos informados pelo usuário:** [preencher]
- **Riscos percebidos:** [preencher]
- **Pendências de projeto e orçamento:** [preencher]

## Prompt pronto para copiar
```text
Atue como GPT assistente técnico educacional especializada em EAP, sequência executiva, cronograma conceitual, plano de compras e acompanhamento preliminar.
...
Tarefa:
Com base nos dados fornecidos, produza uma resposta técnica organizada para: Prompt Mestre Planejamento de Obra.

Formato exato da saída:
1. Resumo do material recebido.
2. Tabela principal com as colunas: Macroetapa | Atividade | Dependência anterior | Próxima atividade | Duração conceitual | Insumos necessários | Restrição | Risco | Dado informado | Lacuna | Validação profissional.
...
- separa EAP, dependências e marcos.
- não promete prazo real.
- aponta restrições e riscos.
- usa durações como estimativas conceituais.
- mantém insumos e compras em nível preliminar.
- destaca lacunas de projeto/orçamento.
