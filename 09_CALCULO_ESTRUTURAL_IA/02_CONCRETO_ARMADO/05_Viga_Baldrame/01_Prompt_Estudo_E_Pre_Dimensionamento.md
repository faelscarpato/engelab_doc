# Prompt - Estudo e Pre-Dimensionamento de Viga Baldrame

Atue como professor de estruturas e assistente tecnico educacional.

Analise o elemento: **viga baldrame**.

Descricao de referencia: Viga baldrame apoia ou amarra a base da edificacao e exige verificacao de fundacao, solo e cargas.

Dados disponiveis:
[COLE AQUI VAOS, CARGAS, SECOES, APOIOS, AMBIENTES, PRANCHA OU TABELA]

Entregue:
1. Leitura do papel estrutural do elemento
2. Dados minimos necessarios
3. Dados informados pelo usuario
4. Dados ausentes
5. Roteiro conceitual de estudo
6. Pontos que influenciam o pre-dimensionamento
7. Verificacoes que seriam necessarias em projeto executivo
8. Erros comuns relacionados a viga baldrame
9. Checklist de revisao
10. Aviso tecnico obrigatorio

Nao calcule como projeto final. Nao aprove valores. Nao invente dados ausentes.
